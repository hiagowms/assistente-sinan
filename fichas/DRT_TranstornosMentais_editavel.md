...
Campo 2 — Agravo/doença: valor fixo, não editável (Transtornos Mentais Relacionados ao Trabalho / CID10: F99)
...
# Seção: Dados Complementares do Caso
...
| AcroForm | Rótulo |
|---|---|
| `habito_alcool` | Álcool |
| `habito_drogas_psicoativas` | Drogas psicoativas |
| `habito_psicofarmacos` | Psicofármacos |
...
## Campo 52 — Conduta Geral
*(1=Sim, 2=Não para cada opção)*

| AcroForm | Rótulo |
|---|---|
| `conduta_afastamento_desgaste` | Afastamento da situação de desgaste mental |
...
## Campo 54 — O paciente foi encaminhado a um Centro de Atenção Psicossocial (CAPS) no SUS ou outro serviço especializado em tratamento de transtornos mentais?

| AcroForm | Rótulo |
|---|---|
| `encaminhamento_caps` | 1=Sim, 2=Não, 9=Ignorado |
...
## Campo 56 — Se Óbito, Data

| AcroForm | Rótulo |
|---|---|
| `obito_data` | Data do óbito |

## Campo 57 — Foi emitida a Comunicação de Acidente do Trabalho (CAT)
