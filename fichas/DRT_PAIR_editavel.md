## Contexto
Este documento mapeia os campos AcroForm de um formulário PDF (SINAN — Ficha de Investigação PAIR) para seus respectivos rótulos e valores aceitos. Com base nas respostas do usuário em um formulário HTML, preencha cada campo com o valor correspondente à escala indicada. Campos de texto livre devem receber a string exatamente como o usuário digitou.
...
Campo 2 — Agravo/doença: valor fixo, não editável (PAIR / CID10: H83.3)
...
| AcroForm | Rótulo |
|---|---|
| `tipo_ruido` | 1=Ruído Contínuo, 2=Ruído Intermitente, 3=Ambos, 9=Ignorado |

## Campo 50 — Exposição Concomitante a Ruído e:
*(1=Sim, 2=Não, 9=Ignorado)*
